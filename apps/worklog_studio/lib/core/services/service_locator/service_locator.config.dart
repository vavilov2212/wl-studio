...
import 'package:worklog_studio/data/sqlite/sqlite_time_entry_repository.dart'
    as _i804;
import 'package:worklog_studio/domain/project.dart' as _i805;
import 'package:worklog_studio/domain/task.dart' as _i806;
import 'package:worklog_studio/domain/time_tracker.dart' as _i807;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i805.ProjectRepository>(
      () => _i802.SqliteProjectRepository(),
    );
    gh.lazySingleton<_i806.TaskRepository>(
      () => _i803.SqliteTaskRepository(),
    );
    gh.lazySingleton<_i807.TimeEntryRepository>(
      () => _i804.SqliteTimeEntryRepository(),
    );
