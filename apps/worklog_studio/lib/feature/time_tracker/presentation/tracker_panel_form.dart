...
class _TrackerPanelFormState extends State<TrackerPanelForm> {
        ...
        builder: (context, state) {
          ...
          return Column(
            ...
            children: [
              ...
              SizedBox(height: theme.spacings.lg),
              _buildFooter(context, isRunning, theme, palette),
            ],
          );
        },
      ),
    ...
    return InlineField(
      ...
      editWidget: Select<String>(
        ...
        actionBuilder: (context, query, close) {
          ...
          return SelectCreateAction(
            label: query.isEmpty
                ? 'Create new task' // TODO: l10n
                : 'Create task "$query"', // TODO: l10n
            onTap: () async {
              if (draftProjectId == null) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Please select a project first'), // TODO: l10n
                  ),
                );
                return;
              }
  ...
  Widget _buildCommentInput(BuildContext context, bool isRunning) {
    ...
    return InlineField(
      ...
      placeholder: 'Add a comment...', // TODO: l10n
