...
- **DO NOT** use `read_file` on entire directories or multiple files sequentially to "browse" the project.
- **Grep-First Strategy:** Always use `search_grep` with exact class names, methods, or unique identifiers to locate logic before reading a file.
